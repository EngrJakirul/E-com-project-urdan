                        ...
                        <div class="card-body bg-light">
                            <form action="{{route('subcategory.update', ['id' => $subCategory->id])}})}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="description" class="form-control" id="" cols="30" rows="10">value="{!! $subCategory->description !!}"</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input type="submit" class="btn btn-success form-control cursor-pointer" value="Update Sub Category" />
                                    </div>
                                </div>
                            </form>
                        </div>
