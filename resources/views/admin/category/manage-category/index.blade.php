                                ...
                                <div class="ibox-body">
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        @foreach($categories as $category)
                                            ...
                                            <td>
                                                <a href="{{route('category.edit', ['id' => $category->id])}}" class="btn btn-sm btn-warning" onclick="return confirm('Are you sure want to edit this.....?')"><i class="fa fa-edit">Edit</i></a>
                                                <a href="{{route('category.delete', ['id' => $category->id])}}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure want to delete this....?')"><i class="fa fa-trash">Delete</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        </tbody>
