                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                                        ...
                                        @foreach($units as $unit)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('unit.edit', ['id' => $unit->id])}}" class="btn btn-sm btn-warning" onclick="return confirm('Are you sure want to edit this.....?')"><i class="fa fa-edit">Edit</i></a>
                                                    <a href="{{route('unit.delete', ['id' => $unit->id])}}" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure want to delete this....?')"><i class="fa fa-trash">Delete</i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
