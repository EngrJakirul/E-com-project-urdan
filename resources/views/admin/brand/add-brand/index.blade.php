                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header bg-light">
                            <h1 class="text-warning text-uppercase text-center">Brand Page Layout</h1>
                        </div>
                        <div class="card-body">
                            <form action="{{route('brand.new')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control summernote" name="description" id="" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                                <div class="row form-group">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="submit" class="form-control btn btn-success cursor-pointer" value="Create New Brand">
                                    </div>
                                </div>
                            </form>
                        </div>
